...
var XMLHttpRequest = require(app.path + 'xmlhttprequest').XMLHttpRequest
var XML            = require(app.path + 'pixl-xml')
var foreach        = require(app.path + 'gulp-foreach')
var path           = require(app.path + 'path')
